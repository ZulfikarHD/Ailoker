			...
			<div class="mx-auto max-w-7xl px-4 py-8 lg:px-10">
				...
				<div class="flex flex-col gap-4 rounded-lg bg-white px-8 py-4 shadow-md shadow-slate-300 drop-shadow">
					...
					<div class="flex flex-wrap items-center gap-3">
						...
						<select id="industriPT" name="industriPT"
					...
					{{-- Ukuran Perusahaan --}}
					<div class="flex flex-wrap items-center gap-3">
						<label for="ukuranPT" class="ml-1 w-[15ch] font-medium text-slate-600">{{ __('Ukuran Perusahaan') }}</label>
						<input id="ukuranPT" name="ukuranPT" type="text" class="flex-1 rounded-md border border-slate-200 px-4 py-2"
							placeholder="Eg. Pertambangan,Pertanian,Manufaktur">
					</div>
					...
					<div class="flex flex-wrap items-center gap-3">
						...
						<div class="flex gap-1">
							<button class="rounded-md bg-emerald-500 px-4 py-2 text-xs font-bold text-green-50">+</button>
							<button class="rounded-md bg-red-500 px-4 py-2 text-xs font-bold text-red-50">-</button>
						</div>
					</div>

					{{-- Kontak Perusahaan --}}
					<div class="flex flex-wrap items-baseline gap-3">
						<label for="kontakPT" class="ml-1 w-[15ch] font-medium text-slate-600">{{ __('Kontak Perusahaan') }}</label>
						<input id="kontakPT" name="kontakPT" type="text" class="flex-1 rounded-md border border-slate-200 px-4 py-2"
					...
					<div class="flex flex-wrap items-baseline gap-3">
						...
						<textarea id="alamatPT" name="alamatPT" class="rounded-md border border-slate-200 px-4 py-2 flex-grow"
				...
				<div class="mt-8 flex flex-col gap-4 rounded-lg bg-white px-8 py-4 shadow-md drop-shadow">
					{{-- Header --}}
					<h1 class="mb-3 border-b-2 pb-3 text-xl font-semibold text-slate-800 dark:text-white">
					...
					<div class="flex flex-wrap items-center gap-3">
						...
						<select id="jenisKelamin" name="jenisKelamin" type="text"
							class="flex-1 rounded-md border border-slate-200 px-4 py-2">
					...
					<div class="flex flex-wrap items-center gap-3">
						...
						<select id="pendidikan" name="pendidikan" type="text"
							class="flex-1 rounded-md border border-slate-200 px-4 py-2">
				...
				<div class="mt-8 flex flex-col gap-4 rounded-lg bg-white px-8 py-4 shadow-md drop-shadow">
					...
					<div class="flex flex-wrap items-center gap-3">
						...
						<input id="regPos" name="regPos" type="text"
							class="flex-1 rounded-md border border-slate-200 px-4 py-2"
							placeholder="Eg. Perusahaan Makmur Sejahter,Indonesia">
					</div>
				...
				<div class="mt-4 w-full">
					<button type="submit"
						class="float-end rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
						Submit
					</button>
				</div>
			</div>
